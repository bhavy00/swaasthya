...
class VitalsInfoDialog extends StatefulWidget {
  const VitalsInfoDialog({super.key});

  @override
  State<VitalsInfoDialog> createState() => _VitalsInfoDialogState();
}

class _VitalsInfoDialogState extends State<VitalsInfoDialog> {
